...
export const combineLatestOperator = () => {
  // const firstTimer = timer(0, 2000); // emit 0, 1, 2... after every second, starting from now
  // const secondTimer = timer(1000, 2000); // emit 0, 1, 2... after every second, starting 0,5s from now
